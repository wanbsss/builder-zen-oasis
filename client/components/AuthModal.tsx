      ...
      <DialogContent className="sm:max-w-md bg-anime-card border-white/10 text-white">
        ...
        <div className="grid grid-cols-3 gap-3">
          <Button
            ...
            className="bg-black/50 border-white/20 text-white hover:bg-white/10 hover:border-red-500/50"
          >
          ...
          <Button
            ...
            className="bg-black/50 border-white/20 text-white hover:bg-white/10 hover:border-indigo-500/50"
          >
          ...
          <Button
            ...
            className="bg-black/50 border-white/20 text-white hover:bg-white/10 hover:border-gray-500/50"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
