...
export default function Browse() {
  ...
  const baseAnimes =
    category === "all" ? animes : getAnimeByCategory(category as any);

  // Filter animes
  const filteredAnimes = baseAnimes
    .filter((anime) => {
      ...
      const matchesGenre =
        selectedGenre === "all" ||
        searchGenres.some((g) => g.includes(selectedGenre));
      const matchesYear =
